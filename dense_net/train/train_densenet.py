"""
Train DenseNet on full-view CheXpert manifests with scaled MSE.
...
DENSE_NET_RESULTS = Path("/resnick/groups/CS156b/from_central/2026/haa/asqin/dense_net_results")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_name", choices=["densenet121", "densenet169"], default="densenet169")
    ...
    parser.add_argument("--runs_base", type=Path, default=DENSE_NET_RESULTS / "runs")
    parser.add_argument("--run_name", type=str, default="densenet169_full512_scaled_mse_mask0_baseline")
